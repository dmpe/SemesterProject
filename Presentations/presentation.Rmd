...
## Agenda | 25 Folien | 20 Minuten | 4 Teilnehmer
...
- **Ziel**:
    + Mithilfe von `R` Modellierung einer Beziehungen zwischen 2 Variablen 
        ...
        + Konzentration auf die Erstellung eines **Linearen Modells**: $y=\beta_0 +\beta_1 x + e$
...
- Deskriptive Überprüfung auf die Normalverteilung 
    + anderen wären verschiedenen Tests, wie z.B. `Chi-Quadrat-Test` usw.
...
- Mehrere Anwendungen, u.a. bei der Transformation auf Normalverteilung [8, 9]
...
- Korrelation bestimmt die Form des elliptischen Wahrscheinlichkeitsfeldes
    + Grosse Korrelation ~> Ellipse ist sehr schmal
    + k(l)eine ~> Kreis-formig 
