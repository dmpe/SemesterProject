...
>- Pionier von *Ross Ihaka* and *Robert Gentleman* in **1991**, seit 1995 unter **GNU GPL**
...
```{r, message=FALSE, out.width="650px", out.height="530px", cache=TRUE, echo=FALSE, fig.align='center'}
library(corrplot)
...
```{r, message=FALSE, out.width="640px", cache=TRUE, echo=FALSE, fig.align='center'}
library(car)

print(round(cor(datasetS.kleiner$Acquaintance, datasetS.kleiner$User.Engage), 3))
...
```{r, message=FALSE, out.width="680px", out.heigh="480px", cache=TRUE, echo=FALSE, fig.align='center'}
library(ggplot2)
...
- Bezeichnet eine wichtige Form der Wahrscheinlichkeistverteilung
  ...
  + Aussehen und Eigenschaften wirden von Erwartungswert und Varianz bestimmt [20, 21]
...
```{r, message=FALSE, cache=TRUE, echo=FALSE, out.width="680px", out.heigh="480px", fig.align='center'}
library(ggplot2)
...
- Graphischen Weg zur Beurteilung, ob Messwerte Realisierungen einer normalverteilten Zufallsvariablen sind. ??????????????
  + Wenn Punkte annähernd auf einer Geraden liegen, sind die Daten näherungsweise normalverteilt, ansonsten nicht. [22]
...
<img src="pictures/project_pos.jpg" height="550" style="display: block;margin-left: auto;margin-right: auto;">
