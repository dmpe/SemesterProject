...
- **Ziel**:
    + Mithilfe von `R` Modellierung der Beziehungen zwischen Variablen 
        ...
        + Konzentration auf **Normalverteilung** und Erstellung eines **Lineares Modells** $y=\beta_0 +\beta_1 x + e$
...
- Bezeichnet eine wichtige Form der Wahrscheinlichkeistverteilung
  ...
  + Aussehen und Eigenschaft wird von Erwartungswert und Varianz [20, 21]
...
--------- | ---------- | ------------- | -----------
User Engage | 0.497 | 0.0005 | 0.490
