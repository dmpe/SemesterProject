...
## Agenda | 24 Folien | 20 Minuten | 4 Teilnehmer | 1 Resultat
...
>- Basiert auf Twitter's `Bootstrap` ("*the most popular HTML, CSS, and JS framework*" [17])

>- **Ziel**: Wie arbeitet man mit `Shiny` & `R` ?
...
* Unsere Ziele am Anfang & im Laufe des Projekts :
    + In `R` uns einzuarbeiten (z.B. auch verschiedenen Prackages zu nutzen)
    + Untersuchung von Daten auf die Zusammenhange (e.g. durch Korrelation, Normalverteilung)
    + Normalverteilung zusatzlich durch QQ-Plots zu bestatigen
