...
- **Ziel**:
    + Mithilfe von `R` Modellierung der Beziehungen zwischen 2 Variablen 
...
Ein graphischer Weg zur Beurteilung, ob Messwerte einer Verteilung Normalverteilt sind.
...
## Abschutzung der linearen Parameter
...
- Muss fur das Lineare Modell, da sonst haben wir problem mit dem Modell.
